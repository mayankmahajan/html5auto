...
if __name__ == '__main__':
    ...
    r = XMLCombiner(['/Users/mayank.mahajan/PycharmProjects/html5automation/configs/coreconfig.xml', '/Users/mayank.mahajan/PycharmProjects/html5automation/configs/solutionconfig.xml']).combine()
    print '-'*20
