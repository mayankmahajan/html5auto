...
neneScreenHandle = getHandle(setup,Constants.NENE)
nenescreenInstance.cm.activateContextMenuOptions1(neneScreenHandle)
nenescreenInstance.cm.GenerateReports(neneScreenHandle)
...
# print data['rows'][2]
print data['rows'][0][1]
checkEqualAssert(result,"sitereports","",""," Destination newtowk element Report is verified")
