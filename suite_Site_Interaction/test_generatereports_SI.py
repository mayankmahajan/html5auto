...
reportname = "siteinteractionreport"
...
siteintScreenHandle = getHandle(setup,Constants.SITEINTERACTIONS)
sitescreenInstance.cm.activateContextMenuOptions1(siteintScreenHandle)
sitescreenInstance.cm.GenerateReports(siteintScreenHandle)
...
if (data['rows'][0][1] == reportname):
    ...
    checkEqualAssert(data['rows'][0][2],"Site Report Average","Today","","Report Type")
    ...
    checkEqualAssert(data['rows'][0][1],reportname,"Today","","Site Report name")
    checkEqualAssert(data['rows'][0][2],"Site Interaction Report Average","Today","","Report Type")
    checkEqualAssert(IsreportIDvalid(data),True,"","","The Report ID ")
